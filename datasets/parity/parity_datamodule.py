...
from parity import generate_parity_data, ParityDataset, save_parity_data
...
class ParityDatamodule(pl.LightningDataModule):
    ...
    def prepare_data(self):
        save_parity_data(vector_size=self.vector_size, num_problems=self.num_problems, path=self.path, extrapolate=self.extrapolate)
